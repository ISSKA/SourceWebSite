export default {
  ...
  description: [
    ...
    '<ul><li><b>Der Creugenat</b>. Ein temporärer Fluss, Überlauf der unterirdischen Ajoulote aus dem Gebiet Chevenez–Courtedoux. </li><li><b>Der Bacavoine</b>, dessen Quelle sich in Fontenais befindet</li><li><b>Die Chaumont-Quelle</b> in der Altstadt am Fusse des Schlosses. </li><li><b>Die Beuchire-Quelle</b>, der ganzjährige Quellaustritt der unterirdischen Ajoulote. </li><li>Die (heute nicht mehr sichtbare)<b>Boucherie-Quelle</b>, die unweit der Beuchire-Quelle liegt. </li></ul>',
    ...
    'Ergänzend zu diesem Ausflug können Sie einen Blick auf die <b>Estavelle des Creugenat</b> werfen, die sich 5 km südwestlich von Pruntrut befindet. Dieses Sinkloch ist eine Öffnung zur Ajoulote, die ganzjährig unterirdisch fliesst und deren Quellaustritt die Beuchire-Quelle ist. ',
    'Ein Besuch der Bacavoine-Quelle im Dorfzentrum von Fontenais ist ebenfalls empfehlenswert. '
  ],
  route: [{
    details: {
      start: 'Parking «Centre» (zwischen der Rue de la Colombière und der Rue du Creugenat)',
      end: 'Parking «Centre»',
      distance: '2,5 km',
      delta_height: '+ 30 m / – 30 m',
      duration: '45 min. ',
      restauration: '',
      type: 'Spaziergang im urbanen Gebiet'
    },
    description: [
	'Der Ausflug beginnt mit der Überquerung der Passerelle über das Flussbett des <b>Creugenat ( A )</b>. Der Fluss fliesst nur nach grösseren Niederschlägen. ',
      'Von der Mitte der Brücke aus kann man flussaufwärts die beiden kleinen <b>Quellen des Gravier ( B )</b> sehen. Im Gegensatz zum Creugenat fliessen diese schlichten Zuflüsse ganzjährig. ',
      'Wir folgen der Rue du Creugenat und biegen dann links in die Faubourg de France ab. Einige Meter vor dem gleichnamigen Tor und dem Eingang zur Altstadt machen wir einen kleinen Abstecher zum Ufer des Creugenat. Flussabwärts ist auf der rechten Uferseite ein Zufluss zu sehen, <b>die Chaumont-Quelle ( C )</b>. Aufgrund ihrer Lage in der Innenstadt war diese Quelle lange Zeit die wichtigste Wasserversorgungsstelle. Heutzutage wird die Stadt von der Betteraz-Quelle gespeist, die sich unterhalb von Pruntrut am Waldrand von Pont d‘Able befindet. Ihr Wasser wird in einer grossen Kläranlage aufbereitet, da es durch frühere industrielle Tätigkeiten stark verschmutzt ist. ',
	'Wir wandern weiter durch die Faubourg de France und steigen dann die Rue Pierre Péquignat und die Rue des Malvoisins hinauf. Der Aufstieg setzt sich in der Rue des Annonciades fort, in der wir den Brunnen <b>Fontaine du Suisse ( D )</b>, aus dem Jahr 1564 finden. ',
	'Oben in der Strasse angekommen, erreichen wir die Rue des Baîches, in der es mehrere <b>Brunnen ( E )</b> gibt. Der Name Baîche stammt aus dem örtlichen Dialekt und bedeutet «Brunnen». ',
	'Wir biegen links in die Grand-Rue ab, wo wir den Brunnen <b> La Samaritaine ( F )</b>. ',
	'Wir setzen unseren Weg in die entgegengesetzte Richtung fort und gehen die Rue Pierre Péquignat hinunter, bis wir rechts in die Rue Joseph Trouillat einbiegen. Hier umrunden wir das Haus, das an der Ecke der beiden Strassen steht, und gehen auf der rechten Seite des Parks entlang. An der Mauer des Gebäudes, an dem Sie vorbeikommen, sehen Sie die Spuren eines <b>Schaufelrads (G)</b>das hier einst hing. Der heute in einer unterirdischen Rohrleitung umgeleitete Bach floss damals hier entlang. ',
	'Auf der linken Seite befindet sich im Park die (nicht sichtbare) <b>Boucherie-Quelle ( H )</b> die mit dem Creugenat verbunden ist. ',
	'Schliesslich gelangen wir zur <b>Beuchire-Quelle( I )</b>, dem ganzjährigen Abfluss des hydrogeologischen Systems der Ajoulote (bzw. des Creugenat). Das Wasser, das aus dieser Quelle fliesst, unterteilt sich in drei Zweige; einer davon fliesst über die oben genannte Leitung zum Flussbett des Creugenat; ein zweiter wird zur Allaine abgeleitet, und der dritte Zweig wird ebenfalls über einen Kanal zum Bacavoine abgeleitet. ',
	'Dieser dritte Zweig tritt einige Dutzend Meter weiter wieder hervor, kurz bevor er mit dem Bacavoine zusammenfliesst <b>( J )</b> und gemeinsam mit ihm durch einen unterirdischen Kanal in die Allaine mündet. '
	]
  },
    ],
  ...
  extras: [
    {
      title: 'Die Estavelle des Creugenat',
	  cover: 'img-4.jpg',
      sumary: '',
      description: [
