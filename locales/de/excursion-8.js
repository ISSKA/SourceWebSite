export default {
  title: 'Soulce-Quellen',
  subtitle: 'Haute-Sorne, JU',
  summary: {
    difficulty: 'xxx',
    duration: 'xxx heures',
    download_file: 'soulce_de.pdf'
  },
  ...
  description: [
    ...
    'Auf dem Gemeindegebiet von Soulce sind mehr als fünfzig Quellen verzeichnet. Wie andernorts auch, sind einige dieser Quellen völlig in Vergessenheit geraten. ',
    ...
    'Der im Rahmen des KAP errichtete <b>Quellen-und Landschaftspfad</b> soll die Bevölkerung über den besonderen Wert der Quellen und die Besonderheiten des ländlichen Kulturerbes der Gemeinde aufklären. ',
    'Der hier vorgestellte Rundwanderweg um Haute-Sorne mit Start in Undervelier folgt einem Teil dieses Pfades. ',
    'Ergänzend zu dieser Wanderung empfiehlt sich ein Besuch zwei weiterer Quellen in der Nähe von Undervelier: die von <b>Blanches-Fontaines</b>, einem prachtvollen Quellaustritt in der Pichou-Schlucht -, und die von <b>Sainte-Colombe</b> in der Grotte, die am Rand der Strasse von Undervelier nach Berlincourt liegt und der Heiligen Kolumba geweiht ist. Praktische Informationen'
  ...
  route: [{
    details: {
      ...
      duration: '3h00 (ohne Pausen)',
      type: 'Einfache Wanderung',
      restauration: 'in Bassecourt (Richtung Delémont)',
    },
    description: [
  ...
  extras: [
    {
      ...
      cover: 'img-1.jpg',
      description: [
	  '<h3>Mehrere Quelltypen in Soulce</h3>',
        '<h5>Fliessquellen</h5>',
	  ...
	  '<h3>Bedeutung der Strukturen und der unterschiedlichen Abflussformen. </h3>',
    ...
    },
    {
      ...
      images: [
        ...
        {
          legend: 'Die Larvenform der Art, die Sie auf der Tafel sehen (Baetis sp.).',
          name: 'img-2.jpg'
        },
      ],
      onTheRoad: true,
	...
	{
    title: 'Die Grotte von Sainte-Colombe',
    sumary: '',
      cover: 'img-1.jpg',
      description:[
        ...
        'Hat die Heilige hier tatsächlich gelebt ? Oder ist es nur der ungewöhnlichen Quelle zu verdanken, dass der Ort heilig gesprochen und dem Wasser wundersame Kräfte zugeschrieben wurden ? Unabhängig von diesen offenen Fragen kommen Christen schon seit langer Zeit hierher, um zu beten. Noch im 19. Jahrhundert kamen Pilger aus Burgund und Lothringen mit ihren kranken oder geistig behinderten Kindern hierher, in der Hoffnung, sie würden nach dem Eintauchen in das Wasser genesen. Auch heute finden noch Wallfahrten an diesen Ort statt, insbesondere an Mariä Himmelfahrt. '
	  ],
	  
      images: [
        {
          legend: 'Die Quelle mit den Votivbildern, die am Boden der Grotte von Sainte-Colombe deponiert sind.',
          name: 'img-1.jpg'
        },
	...
	{
    title: 'Die Quellen der Blanches-Fontaines',
    sumary: '',
    cover: 'img-1.jpg',
      description:[
        ...
        'Bei Niedrigwasser beträgt der durchschnittliche Ablauf 0, 5 m3 / s, bei Hochwasser kann er 12 oder sogar 15 m3 / s erreichen; somit ist es eines der grössten Quellsysteme im nördlichen Jura. Während der Schneeschmelze oder nach starken Unwettern bieten die Quellen ein eindrückliches Bild, und überall sprüht die Gischt hervor. Eine dieser Quellen ist bemerkenswert, denn sie fliesst nur in Hochwasserperioden, wenn sie allein 1 bis 2 m3 / s ausstösst. ',
        ...
        'Bleibt die Frage: Woher kommt das Wasser der Blanches-Fontaines ? Färbeversuche haben ergeben, dass es eine hydrogeologische Verbindung zwischen mehreren Schächten in der Region von Lajoux und Bellelay und dieser Quelle gibt; somit konnte ein Einzugsgebiet von 40 km2 bestimmt werden. '
	  ],
      images: [
        {
          legend: 'Einer der vielen Ausflüsse der Blanches-Fontaines.',
          name: 'img-1.jpg'
        },
