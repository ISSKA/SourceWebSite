export default {
  ...
  source: {
    ...
    name: 'Die Quelle von Chilchbalm',
    canton: 'BE'
  },
  description: [
  ...
  route: [{
    ...
    details: {
      ...
      restauration: 'Restaurant in Rütti/Stechelberg',
  ...
  extras: [
    {
      title: 'Die Quelle von Chilchbalm',
	  cover: 'img-1.jpg', 
      sumary: '',
      description: [
      ...
      images: [
        {
          legend: 'Die Quelle von Chilchbalm.',
          name: 'img-1.jpg'
        },
        {
          legend: 'Das Sefinental und die Nordseite des Gspaltenhorns.',
          name: 'img-2.jpg'
        },
