export default {
  title: 'Die Quelle der Serrière',
  subtitle: 'Neuchâtel, NE',
  summary: {
    difficulty: 'xxx',
    duration: 'xxx heures',
    download_file: 'serrieres_de.pdf'
  },
  source: {
  ...
  route: [{
    ...
    description: [
      ...
      '<b>C:</b> 1892 wurde eine Seilbahn, genannt „plan incliné“ („schiefe Ebene“), errichtet, die das Tal mit dem Bahnhof verband und somit den Transport der hier gefertigten Papier- und Schokoladenwaren in die Schweiz und nach Europa ermöglichte. Im Jahr 1954 wurde sie abgerissen. Daneben gab es ein beachtliches Schmalspur-Schienennetz(Marke Decauville), mit dem Güter zwischen den einzelnen Werksgebäuden befördert wurden. ',
      '<b>D:</b> Der Weg steigt zunehmend an, bis er plötzlich vor einem Steilhang endet. Ein starkes Wasserrauschen ist nun vernehmbar, obwohl wir bislang kein Wasser zu sehen bekommen haben. Beim Nähertreten erkennen wir, dass das Wasser aus einem grossen Steinblock hervorquillt. Wir sind an der Quelle der Serrière angelangt, dem kürzesten Fluss des Kantons Neuenburg: genau 665 Meter, ein Grossteil davon unterirdisch, trennen die Quelle von ihrer Mündung im See. '
	]
  },
    ],
  ...
  extras: [
    {
      title: 'Ein Ort mit hoher Industriedichte',
	  cover: 'img-1.jpg',
      sumary: '',
      description: [
        ...
        'Im Jahr 1811 gab es an der Serrière 38 Wasserräder, von denen je elf für den Antrieb von Schmieden und Getreidemühlen sorgten, je vier zum Antrieb von Sägereien und Walzwerken dienten und eines ein Polierwerk antrieb. In den Schmieden wurde das Wasser benutzt, um das Eisen mit dem Schmiedehammer zu bearbeiten. Die Dreschmühlen dienten dazu, Hanf, Früchte, Mais, Eicheln und verschiedene Mineralstoffe zu mahlen. Die Ölmühlen pressten Ölsamen und-früchte(Nüsse, Haselnüsse, Sonnenblumensamen), um Speise-und Lampenöl zu gewinnen. Die Walkmühlen dienten der Tuchherstellung und der Ledergerberei. Der Schneidwarenhersteller fertigte Sensen und Messer. ',
    ...
    {
      title: 'Eine Hochburg für Papierherstellung',
	  cover: 'img-1.jpg',
      sumary: '',
      description: [
      ...
      images: [
        {
          legend: 'Kakaomahlwerkstatt in der Fabrik Suchard in Serrières.',
          name: 'img-1.jpg'
        },
        {
          legend: 'Ganz unten in der engen Schlucht der Serrière, wo das Wasser aus dem Boden sprudelt, wurde 1477 die erste Papierfabrik errichtet.',
          name: 'img-2.jpg'
        },
      ...
      title: 'An der Quelle der Suchard Schokolade',
	  cover: 'img-1.jpg',
      sumary: '',
      description: [
      ...
      images: [
        {
          legend: 'Serrières, vom Bahnhof aus (um 1900), Gouache von Johannes Weber (1846-1912). Dieses Bild erinnert an die entscheidende Bedeutung des Wassers in der Industrie des 19. Jahrhunderts: Vor dem Hintergrund des ewigen Schnees sieht man eine Dampflokomotive, einen Fluss, der die hydraulische Kraft für den Antrieb der Mühlen von Suchard erzeugt, und auf dem See ein von Schaufelrädern angetriebenes Dampfschiff. 1826 gründete Philippe Suchard eine Schokoladenfabrik in der Mitte des Tals, wo der Fluss Serrière fliesst, und profitierte von der Quelle, die die notwendige Energie für den Betrieb einer Kakaobohnenmühle lieferte.',
          name: 'img-1.jpg'
        },
	...
	{
    title: 'Der Zusammenhang zwischen dem Seyon und der Quelle der Serrière',
	  cover: 'img-1.jpg',
      sumary: '',
      description: [
