export default {
  ...
  description: [
    {
      label: 'xxx',
      details: 'Blottie au fond d’une vallée sauvage, la source de Chilchbalm est très impressionnante. Elle jaillit en pleine falaise à environ 30 mètres du sol. A ses pieds, un petit glacier occupe le fond de la vallée de Sefinen et, au-dessus d’elle, le Gspaltenhorn la domine du haut de ses 3436 m d’altitude. Les orifices d’où jaillissent l’eau ne peuvent s’atteindre qu’au prix d’une escalade engagée. Il y a peu de temps encore, cette source était dissimulée par la masse du glacier. C’est grâce à la fonte de celui-ci qu’on peut aujourd’hui la voir et l’admirer de loin. A ce jour, on sait peu de choses sur cette source, si ce n’est qu’elle est très belle et mérite le détour ! L’origine précise de ses eaux (bassin d’alimentation) n’est pas (encore) connue des hydrogéologues et les spéléologues n’ont pas (encore) pu explorer cette source – pour autant que cela soit techniquement possible...'
    }
  ],
  route: {
    details: {
  ...
  extras: [
    {
      ...
      description: [
        ...
        'Un lieu, un prétexte, une occasion de se laisser aller à un peu de philosophie. Qu’est-ce qu’une source ? D’où vient-elle ? Que se cache-t-il derrière ? Est-ce une porte de l’enfer souterrain ? Ou plutôt l’émergence de toute vie ? Quels génies bienfaisants y logent-ils ? A moins que ce soient de vilains démons ?'
